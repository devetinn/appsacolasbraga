...
export function TabelaProducoes({ entries, loading, totalUnidades, valorEstimado }: TabelaProducoesProps) {
  if (loading) {
    return (
  ...
  return (
    <div className="flex flex-col">
      {/* Cabeçalho */}
      <div className="grid grid-cols-[56px_20px_1fr_52px_28px_44px_28px] gap-x-2 px-3 pb-1.5 border-b border-black/[0.06]">
      ...
      <ul className="divide-y divide-black/[0.04]">
        {entries.map((e) => (
          <li
            key={e.id}
            className="grid grid-cols-[56px_20px_1fr_52px_28px_44px_28px] gap-x-2 px-3 py-2.5 items-center"
          >
